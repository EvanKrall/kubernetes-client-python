...
# This patch reuses the same Configuration object for all model objects constructed by the ApiClient.
# This speeds up deserialization drastically.
git apply "${SCRIPT_ROOT}/api_client_configuration.diff"
